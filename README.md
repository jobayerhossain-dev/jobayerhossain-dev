...
<!-- ##################### My openion ######################## -->
<br/>
<p align="justify"><strong>I'm Jobayer Hossain. I'm dedicated to building Web Applications and Github Profile. I enjoy helping people create their online presence and am also particularly pleased with coding. Because of this, I strive to do my best in Web Application Development and design Github Profile. <br/>
I believe that a good website can lead to a great business and a beautiful GitHub profile can represent a person or an organization beautifully.
</strong></p> 
...
<table border="2">
  ...
  <tr>
    ...
    <td align="justify"> This is a command-line based banking system implemented in Python with MySQL integration. The program allows users to perform basic banking operations such as creating accounts, depositing money, withdrawing funds, and viewing account details. </td>
    <td align="center"> --- </td> 
  ...
  <tr>
    ...
    <td align="justify">This is a web application to help you track your daily routine tasks. You can add tasks, mark them as completed for each day of the week, and easily manage your habits. </td>
  ...
  <tr>
    <td> E Book Reader </td>
    <td align="justify"> The E-book Reader app is a command line based application specializing in audio books developed using Python. Users can enjoy a seamless listening experience, play audio books with ease, offering a convenient and efficient way to enjoy books in audio format. </td>
    <td align="center"> --- </td> 
    <td align="center">  <a href="https://github.com/jobayerhossain-dev/E-Book-Reader#e-book-reader" target="_blank"> <img src="./image/open-book.png" alt="Daily Routine Tracker"> </a> </td>
  </tr>
